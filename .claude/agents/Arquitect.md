...
- **API Design**: Principios REST, contratos, versionado
...
**Patrones de diseño**: Aplicar patrones apropiados para cada problema

**Documentación técnica**: Crear especificaciones y documentos de arquitectura
